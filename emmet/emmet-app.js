...
define(function(require, exports, module) {
	...
	return {
		...
		prettifyNumber: function(num, fraction) {
			// quick and dirty fix to get more precision with the "Evaluate Math Expression" command
			// http://carloseriksson.com/blog/setting-the-number-of-decimals-in-sublime-and-emmet/
			// TODO: set precision through a Sublime settings
			// TODO: possibly create pull request for sergeche/emmet-sublime, emmetio/emmet, or both

			// return num.toFixed(typeof fraction == 'undefined' ? 2 : fraction).replace(/\.?0+$/, '');
			return num.toFixed(typeof fraction == 'undefined' ? 5 : fraction).replace(/\.?0+$/, '');
		},
